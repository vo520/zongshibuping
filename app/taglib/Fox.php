...
class Fox extends Taglib
{
    ...
    protected $tags = [
        ...
        'language' => ['attr' => 'name,path,currentstyle,key,toggle,self', 'close' => 1], //语言
        ...
        'sitemap' => ['attr' => 'title,type,target,langtitle', 'close' => 0], //网站地图
    ...
    public function tagSitemap($attr)
    {
        ...
        $langtitle = $attr['langtitle'] ?? "";
        $parse = '<?php ';
        $parse .= '$param = [\'title\'=>\'' . $title . '\',\'type\'=>\'' . $type . '\',\'target\'=>\'' . $target . '\',\'langtitle\'=>\'' . $langtitle . '\'];';
    ...
    public function tagLanguage($attr, $content)
    {
        ...
        $self = $attr['self'] ?? "false"; // self 参数（是否包含当前语言）
        $index = $attr["key"] ?? "index";
        $parse = '<?php ';
        $parse .= '$param = [\'path\'=>\'' . $path . '\',\'currentstyle\'=>\'' . $currentstyle . '\',\'toggle\'=>\'' . $toggle . '\',\'self\'=>\'' . $self . '\'];';
